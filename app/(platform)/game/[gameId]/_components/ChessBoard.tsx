...
import { MOVE } from "@/constants/game";
...
import { drawArrow } from "@/lib/canvas";
...
export const ChessBoard = ({
  ...
  const moveAudio =
    typeof Audio !== "undefined" ? new Audio("/move.wav") : null;
  const captureAudio =
    typeof Audio !== "undefined" ? new Audio("/capture.wav") : null;
